TASK_DESCRIPTIONS = {
    "sst-5": ...,
    "agnews": "The dataset contains news articles categorized into four classes: World, Sports, Business, and Tech. The task is to classify each news article into one of the four categories.",
    "subj": ...,
    "rte": ...,
    "gsm8k": "The dataset consists of elementary school math word problems that require multi-step reasoning to solve. The task is to solve each word problem and provide the final answer.",
}
